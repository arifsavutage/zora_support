            ...
            <div class="card-body">
                <form name="addproduct" method="post" action="">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="kategoriid" name="kategoriid">
                            ...
                            <?php foreach ($kategori as $a) : ?>
                                <option <?= $a->ID == $product->CAT_ID ? 'selected' : '' ?> value="<?= $a->ID ?>"><?= $a->CATEGORY_NAME ?></option>
                            <?php endforeach; ?>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="<?= $product->PRODUCT_NAME ?>" class=" form-control" id="productname" name="productname" placeholder="nama produk">
                        <small class="form-text text-danger"><?= form_error('productname') ?></small>
                    </div>
                    <div class="form-group">
                        <label for="sellprice">Harga Jual</label>
                        <input type="text" value="<?= $product->SELL_PRICE ?>" class=" form-control" id="sellprice" name="sellprice" placeholder="harga jual">
                        <small class="form-text text-danger"><?= form_error('sellprice') ?></small>
                    </div>
                    <div class="form-group">
                        <label for="stock">Stock</label>
                        <input type="text" value="<?= $product->STOCK ?>" class=" form-control" id="stock" name="stock" placeholder="stock">
                        <small class="form-text text-danger"><?= form_error('stock') ?></small>
                    </div>
                    <div class="form-group">
                        <label for="stocklimit">Stock Limit</label>
                        <input type="text" value="<?= $product->STOCK_LIMIT ?>" class=" form-control" id="stocklimit" name="stocklimit" placeholder="stock limit">
