            ...
            <div class="card-body">
                ...
                <small class="form-text text-danger"><?= isset($errors) ? $errors : '' ?></small>
                    <div class="form-group">
                        ...
                        <input type="text" value="<?= set_value('ktpmarketing') ?>" class="form-control" id="ktpmarketing" name="ktpmarketing" placeholder="no. KTP">
                        <small class="form-text text-danger"><?= form_error('ktpmarketing') ?></small>
                    </div>
                    <div class="form-group">
                        <label for="marketingname">Nama Marketing</label>
                        <input type="text" value="<?= set_value('marketingname') ?>" class="form-control" id="marketingname" name="marketingname" placeholder="nama Lengkap">
                        <small class="form-text text-danger"><?= form_error('marketingname') ?></small>
                    </div>
                    <div class="form-group">
                        <label for="alamatmarketing">Alamat Marketing</label>
                        <textarea class="form-control" name="alamatmarketing" placeholder="alamat marketing"><?= set_value('alamatmarketing') ?></textarea>
                        <small class="form-text text-danger"><?= form_error('alamatmarketing') ?></small>
                    </div>
                    <div class="form-group">
                        <label for="telpmarketing">No. Telp</label>
                        <input type="text" value="<?= set_value('telpmarketing') ?>" class="form-control" id="telpmarketing" name="telpmarketing" placeholder="No. Telp / HP">
